...
protected:
  ...
  // Input/output speed controls using standard ROS2 publishers/subscribers
  /// @brief Input cmd_vel subscriber (Twist)
  rclcpp::Subscription<geometry_msgs::msg::Twist>::SharedPtr cmd_vel_in_sub_;
  /// @brief Input cmd_vel subscriber (TwistStamped)
  rclcpp::Subscription<geometry_msgs::msg::TwistStamped>::SharedPtr cmd_vel_in_stamped_sub_;
  /// @brief Output cmd_vel publisher
  rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::TwistStamped>::SharedPtr cmd_vel_out_pub_;
